...
<ul class="nav nav-tabs">
	...
	<li role="presentation" class="active"><a href="manager.action">管理员管理</a></li>
...
%>
<form action="update-manager" method="get">
	<table id="dataTable" class="display" cellspacing="0" width="100%">
		...
		%>
		<tr>
			<td><%=manager.getM_id()%></td>
			<td><%=manager.getM_name()%></td>
			<td><%=manager.getM_pwd()%></td>
			<td><input  type="checkbox" name="cb_delete" value="<%=manager.getM_id()%>"/></td>
		</tr>
		<%
			}
		%>
		...
		<tr>
			<td><input type="text" name="m_id" class="form-control" placeholder="工号"></td>
			<td><input type="text" name="m_name" class="form-control" placeholder="姓名"></td>
			<td><input type="text" name="m_pwd" class="form-control" placeholder="密码"></td>
